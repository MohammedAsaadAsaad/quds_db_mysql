...
class MysqlSelectQueryBuilder<T> implements SelectQueryBuilder<T> {
  final MysqlDatabaseConnection _connection;
  ...
  MysqlSelectQueryBuilder(this._connection);
...
class MysqlAggregateQueryBuilder<T> implements AggregateQueryBuilder<T> {
  final MysqlSelectQueryBuilder<T> _selectBuilder;

  MysqlAggregateQueryBuilder(this._selectBuilder);
